...
public class Global : Singleton<Global>
{
    ...
    public Dictionary<string, EffectClause> Effects = new()
    {
        ...
        { "e5", new("e5", "Berserker's Axe", "+10 dmg for each attack performed this round", "#ff0000".HexColor(), 6) },
        { "e6", new("e6", "Single Glove", "Solo dice on this card +40 dmg", "#ff00bf".HexColor(), 7) },
        { "e7", new("e7", "Feathered Blade", "Sequence get +20 dmg", "#0000ff".HexColor(), 5) },
        ...
        { "e19", new("e19", "Loaded Crossbow", "Consume 1 attack, gain 1x mult, disable this card", "#ff0000".HexColor(), 8, Rarity.Rare) },
        ...
        { "e22", new("e22", "Preservation Ring", "Gain 0.2x mult, increase by 0.1x foreach unused reroll after each round, currently [v0]", "#00ff00".HexColor(), 15, Rarity.Rare) },
        { "e23", new("e23", "Chaos Trinket", "+30 dmg for each dice not used in a pattern", "#8000ff".HexColor(), 5) },
        { "e24", new("e24", "Automation Controller", "All high value (5+) always attack regardless of pattern", "#8000ff".HexColor(), 5) },
        ...
        { "e26", new("e26", "Mirror Prism", "Dice on this card allways attack with value x 3", "#0000ff".HexColor(), 7) },
